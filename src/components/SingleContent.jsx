...
export const SingleContent=({id,poster_path,title,name,overview,media_type,release_date,first_air_date,vote_average,type      })=> {
  ...
  return (
    ...
    {open && <DetailModal open={open} setOpen={setOpen} id={id} media_type={media_type||type} type={media_type}/> }
    </>
  );
}
